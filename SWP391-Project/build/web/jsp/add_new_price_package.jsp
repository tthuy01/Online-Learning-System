<%-- 
    Document   : add_new_price_package
    Created on : Jul 14, 2022, 1:16:23 PM
...
<html>
    <head>
        ...
        <title>Add new price package</title>
    ...
    <body>
        <section id="wrapper-dashboard" class="row container-fluid mx-auto px-0">
            <div id="left" class="col-lg-2 col-md-4 col-12 px-0" style="padding-bottom: 120px;">
            ...
            <div id="right" class="col-lg-10 col-md-8 col-12" style="padding-bottom: 120px;">
                <jsp:include page="header_admin.jsp"/>
                <div class="registration-container" style="margin-top: 35px;">
                    <div class="title-add" style="margin-left: 2%; margin-bottom: 2%;">
                        <h4><a href="subjectdetails?cid=${cid}">Subject detail </a><b>></b> Add new price package</h4>
                    </div>
                    <div class="ms">
                    ...
                    <div class="content-add d-flex justify-content-center">
                        <form action="addnewpricepackage?cid=${cid}" method="post">
                            <table>
                                <tr>
                                    <td>Package name</td>
