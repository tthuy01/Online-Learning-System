    ...
    <body>
        <section id="wrapper-dashboard" class="row container-fluid mx-auto px-0">
            ...
            <div id="right" class="col-lg-10 col-md-8 col-12">
                ...
                <h4 class="mt-3 mb-3 mx-5"><a href="sliderlist" >Sliders List</a><i class="fa-solid fa-angle-right mx-2"></i>Slider Details</h4>
                <div class="mx-5">
                    <form method="post" action="editslider" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-row col-md-6">
                                <div class="form-group col-md-12">
                                    ...
                                    <input style="background-color: white;" disabled type="text" class="form-control" name="link" id="link" placeholder="Enter Backlink" value="${slider.link}">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>Note</label>
                                    <input style="background-color: white;" disabled type="text" class="form-control" name="note" id="note" placeholder="Enter Note" value="${slider.note}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Status</label>
                                    <select style="background-color: white;" id="status" name="status" class="form-control" disabled>
                            ...
                            <div class="form-row col-md-6">
                                <div class="form-group col-md-12 d-flex flex-column">
                                    <label>Image</label>
                                    <img id="blah" class="img-fluid" style="width: 100%;height: 210px;border: 1px solid black" src="./images/slider/${slider.image}" alt="your image"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            ${slider.title}
                            <!--<textarea disabled id="inputTitle" name="title">${slider.title}</textarea>-->
                        </div>
                        <span onclick="window.location.href = 'editslider?id=${slider.id}'" class="btn btn-primary">Edit This Slider</span>
                    </form>
                </div>
            </div>
        </section>
