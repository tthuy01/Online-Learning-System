            ...
            <section id="wrapper-dashboard" class="row container-fluid mx-auto px-0">
                ...
                <div id="right" class="col-lg-10 col-md-8 col-12" style="${listCourse.size() < 5 ? "margin-bottom: 200px" : ""}">
                    ...
                    <nav class="body_content mx-auto" style="width: 95%;">
                        <h4 class="mt-3 mb-3 "><a href="postlist" >Post List</a><i class="fa-solid fa-angle-right mx-2"></i>New Post</h4>
                        ...
                        <div class="mb-3 mx-auto justify-content-center" style="width: max-content;">
                            <c:if test="${successfull eq 'Add new Post successfully!'}">
                                <button onclick="Back()">Go to Post List</button>
                            </c:if>
                        </div>
<!--                        <div class="title">
                            <h4>Add New Post</h4>
            ...
            <!--                        <input class="mt-3 mb-4 w-75" name="name" type="text" value="${post.potitle}"><br>-->
                                    <textarea name="title" class="mt-3 mb-4 w-75" required>${post.potitle}</textarea><br>
                                ...
                                <div class="body_head_right col-6 col-md-4 mb-3 ">                                    
                                    <img id="output" class="w-75 border" 
                                         src="${post.poimg}">                                    
                                    ...
                                    <div class="choose mt-3">
                                        <!--                                        <div class="uploaad_img">
                                                                                    <input type="file" accept="image/*" name="image" id="file" onchange="loadFile(event)"
                                                                                           style="display: none;">
                                                                                    <label for="file" style="cursor: pointer;border: 1px solid;padding: 5px;">Upload Image</label>
                                                                                </div>-->
                                        <div class="link_img mt-2">
                                            <span>Input image link in online library</span><br>
                                            <input class="mt-2" type="text" id="image">
                                            <input  type="button" value="Choose image in link" onclick="MyFunction()">
                            ...
                            <div class="mt-4">
                                ...
                                <input class="ml-3" type="button" value="Back to post list" onclick="Back()">
                            </div>
                        </form>
                    </nav>
