...
public class JSPFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(url.endsWith("account.jsp"))
        {
            httpResponse.sendRedirect("/project/login");
            return;
        }
        else if(url.endsWith("user_profile.jsp"))
        {
            httpResponse.sendRedirect("/project/userprofile");
            return;
        }
        else if(url.endsWith("change_password.jsp"))
        {
