<%-- 
    Document   : header
    Created on : May 28, 2022, 6:33:06 PM
    Author     : Dell
--%>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 fixed-top" w3-include-html="header.jsp">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <!--Search-->
                <form class="form-inline my-2 my-lg-0 ml-5" method="get" action="searchsubject">
                    <input class="form-control mr-sm-2" type="search" name="search" value="${search}" placeholder="Enter subject" aria-label="Search">
