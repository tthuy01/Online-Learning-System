<%-- 
    Document   : add_new_setting
    Created on : Jul 8, 2022, 3:29:55 PM
    ...
    <body>
        <jsp:include page="header.jsp"></jsp:include>
            <div class="add-container" style="margin-bottom: 2%;">
                <div class="add-path">
                    <h4><a href="settinglist">List of settings</a> > Add new setting</h4>
                </div>
                <div class="add-form d-flex justify-content-center" style="margin-top: 1%;">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>                 
                                <select name="status">
                                    <option value="-1">Choose setting status</option>
                    ...
                    <div class="add-button d-flex justify-content-center" style="margin-top: 2%;">
                        <button type="button" class="btn btn-primary btn-sm" onclick="this.form.submit();">Add new</button>
                    </div>
                </form>
            </div>
        </div>
